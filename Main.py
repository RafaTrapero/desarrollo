...
from textMining.TextMining import cleanAndtokenize,remove_stopwords_from_column,get_unique_words_by_label,calculate_non_zero_tfidf,filter_tfidf_by_threshold
from utils.Utils import agregar_columnas_por_palabra2, contar_palabras, palabras_mas_frecuentes_por_label,agregar_columnas_por_palabra,palabras_por_label,columnas_a_eliminar,feature_selection_cascade
...
df_global = df_global[df_global['label'] != 'U']
...
df_final=agregar_columnas_por_palabra2(df_global_sin_stopwords,result)
...
print('--------------- LR CV----------------')
#lr_cv=logistic_regression_tuning_cv(X_train, y_train, X_test, y_test,50)
